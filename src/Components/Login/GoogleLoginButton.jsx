...
const GoogleLoginButton = ({ disabled, clickFunction }) => {
    return (
        <button className='flex space-x-5 items-center justify-center cursor-pointer rounded-full py-1.5 w-full border border-neutral-300 hover:bg-orange-50 duration-150 delay-75 text-md text-neutral-900'
            disabled={disabled} onClick={clickFunction}>
            <div className=''>
